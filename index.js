...
function _parseSubdomains(tag) {
	var data = _parseTag(tag.data);
	var subdomainInfo = {
		ReverseDomainName: data["00"],
		SubmerchantNumber: data["01"],
		OrderNumber: data["02"],
	};
